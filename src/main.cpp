...
int main()
{
    ...
    std::string shaderDir = "/res/shaders/";
	// Generates Shader object using shaders default.vert and default.frag
	Shader shaderProgram((parentDir + shaderDir + "default.vert").c_str(), (parentDir + shaderDir + "default.frag").c_str());
	...
	*/
	...
	//parentDir was prev defined as main folder dir
	...
	while (!glfwWindow.getShouldClose())
	{
		...
		glfwWindow.bitClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
